...
---
## 维护者核实（Claude）
Verdict: Reviewed-Pass-with-fixes。两条均核实属实并已修：line 10/53 区分“论文用 1.3B/7.5B 纯网页模型”作为 web-only 直接证据；Falcon-7B/40B 受其启发、以 RefinedWeb 为主但叠加了部分 curated 语料、并非纯网页。
