...
---
## 维护者核实（Claude）
Verdict: Reviewed-Pass-with-fixes。三条均核实属实并已修：①一句话弱化“第一次”、补 NNLM/LSA 雏形；②“今天怎么看”澄清输入 token embedding 仍是静态查表、上下文性来自后续网络（含原 line 103）；③延伸阅读 glove.pdf → GloVe 官方项目页（去 PDF）。
